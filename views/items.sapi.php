<body>
  <div class="bg-violet-100 flex flex-col items-stretch">
      ...
      <div class="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
        <div class="flex flex-col items-stretch w-3/5 max-md:w-full max-md:ml-0">
          <div class="items-stretch flex flex-col max-md:max-w-full max-md:mt-10">
            <div class="text-gray-900 text-xl font-medium leading-6 whitespace-nowrap max-md:max-w-full">
              &lt;back to home
            </div>
    ...
    <div class="items-center shadow-sm bg-gray-900 flex w-full flex-col justify-center mt-12 px-16 py-12 max-md:max-w-full max-md:mt-10 max-md:px-5">
