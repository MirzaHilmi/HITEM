<body class="bg-[#A887DC] flex">
    ...
    <main class="flex flex-col justify-start gap-8 p-12 w-full">
            ...
            <table class="table-fixed w-full text-sm text-left rtl:text-right text-gray-500">
                ...
                <tbody class="text-lg font-bold text-white">
                    <tr class="border-b">
                        ...
                        <td class="px-6 py-4">
                            Warna Hitam, Ujungnya Hitam, Belakangnya Hitam, dan Atasnya Hitam
                        </td>
                        <td class="px-6 py-4">
                            GKM
                        </td>
                        ...
                        <td class="px-6 py-4">
                            <form action="/admin/items" method="POST">
                                ...
                                <button type="button" class="bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg px-5 py-2.5 text-center inline-flex items-center me-2">
